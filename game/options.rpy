...
init -1 python hide:
    ...
    config.window_title = u"Joan Collell"
    ...
    # config.main_menu_music = "joan.ogg"
...
python early:
    config.save_directory = "joc-1376414804"
...
init python:
    ...
    build.directory_name = "joan-1.0"
    
    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "joan"
